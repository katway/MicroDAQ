...
namespace demo
{
    ...
    /// </summary>
    public partial class NModbusOperate : Component,IModbus
    {
       #region 全局变量和构造函数
        IModbusSerialMaster master;
         ...
         public NModbusOperate()
         {
             InitializeComponent();
         }
         public NModbusOperate(IContainer container)
        {          
            container.Add(this);
            InitializeComponent();
        }
       ...
       #region 读取存储器数据
        ...
        private void  ReadInputRegisters()
        {
            ...
            //ushort[] holdRegister = master.ReadHoldingRegisters(1, 0, 47);         
        }
